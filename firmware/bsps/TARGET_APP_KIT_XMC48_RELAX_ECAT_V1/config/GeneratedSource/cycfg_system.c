...
#define CLOCK_USBPLL_ENABLED 1U
#define CLOCK_USBPLL_PDIV 3U
#define CLOCK_USBPLL_NDIV 100U
...
#define CLOCK_ECATCLK_ENABLED 1U
#define CLOCK_ECATCLK_DIV 2U
#define CLOCK_ECATCLK_SEL XMC_SCU_CLOCK_ECATCLKSRC_USBPLL
